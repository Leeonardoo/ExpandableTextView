...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void initValue(Context context, AttributeSet attrs) {
        ...
        if (null == drawableShrink) {
            drawableShrink =
                    ContextCompat.getDrawable(context, R.drawable.ic_keyboard_arrow_up_black_18dp);
        }
    ...
    public void setText(CharSequence charSequence) {
        ...
        textContent = Spannable.Factory.getInstance().newSpannable(charSequence);
     ...
     * get content text
     *
     * @return content text as a Spannable
     */
